...
public class NumerosRomanosTest {
    ...
    public void pasar10Aromanos(){
        String romano = numerosRomanos.convertirRomanos(10);
        assertEquals(romano, "X");
    }

    @Test
    public void pasar11Aromanos(){
        String romano = numerosRomanos.convertirRomanos(11);
        assertEquals(romano, "XI");
    }

    @Test
    public void pasar12Aromanos(){
        String romano = numerosRomanos.convertirRomanos(12);
        assertEquals(romano, "XII");
    }

    @Test
    public void pasar13Aromanos(){
        String romano = numerosRomanos.convertirRomanos(13);
        assertEquals(romano, "XIII");
    }

    @Test
    public void pasar14Aromanos(){
        String romano = numerosRomanos.convertirRomanos(14);
        assertEquals(romano, "XIV");
    }

    @Test
    public void pasar15Aromanos(){
        String romano = numerosRomanos.convertirRomanos(15);
        assertEquals(romano, "XV");
    }

    @Test
    public void pasar16Aromanos(){
        String romano = numerosRomanos.convertirRomanos(16);
        assertEquals(romano, "XVI");
    }

    @Test
    public void pasar17Aromanos(){
        String romano = numerosRomanos.convertirRomanos(17);
        assertEquals(romano, "XVII");
    }

    @Test
    public void pasar18Aromanos(){
        String romano = numerosRomanos.convertirRomanos(18);
        assertEquals(romano, "XVIII");
    }

    @Test
    public void pasar19Aromanos(){
        String romano = numerosRomanos.convertirRomanos(19);
        assertEquals(romano, "XIX");
    }

    @Test
    public void pasar20Aromanos(){
        String romano = numerosRomanos.convertirRomanos(20);
    ...
    public void verificarVeintenaNumeroRomanos(){
        ...
        List<String> romanos = numerosNaturales.stream()
                .map(number -> numerosRomanos.convertirRomanos(number))
